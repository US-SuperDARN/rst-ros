/* widetest.c
   ==========
   Author: R.J.Barnes
   with mods from SGS and EGT

 Basic Parameters:
   Scan from start_beam to end_beam in sequence, alternating between
   narrow and wide transmission beams on each scan.
 ...
 v1.7 - SGS
  ...
  20251003 EGT modifying normalscan to alternate between narrow and wide TX
...
char progid[80]={"widetest 2026/02/18"};
char progname[256];
...
int rst_opterr(char *txt) {
  ...
  fprintf(stderr,"Please try: widetest --help\n");
  return(-1);
}
